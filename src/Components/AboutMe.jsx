    ...
    <div className="about-me-section">
      ...
      <figure className="text-center">
        <blockquote className="blockquote">
          <p>
            Whoever is passive and wonders knows his ignorance. Astonishment is
      ...
      <div>
        <div className="description-rectangles container">
          ...
          >
            ...
            <p>
              ...
              Świętokrzyska Polytechnic but I dont vibe with it as much as with
              code (thats why you are reading this).
            </p>
          </div>
          <div
            className={
        ...
        <div className=" description-rectangles container">
          ...
          >
            <h2>Challange me</h2>
            <p>
              I love challenging myself, keep learning and do intresting things.
              Except coding I am making instrumnetal/beats, writitng scenarios
              for my friends music videos and cooking. I really like to see
              effects when I am doing something and because of this coding and
              music for me is really similar except that code I can see but
              music I can hear.
            </p>
          </div>
          <div
